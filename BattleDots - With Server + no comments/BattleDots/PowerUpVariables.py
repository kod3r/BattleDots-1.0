...
class PowerUpVariables(ClientVariables):
    ...
    def __init__(self, PowerUpsInUse, client):
    ...
    def setDotSize(self):
        ...
        self.CLIENT.sendData(self.CV.PLAYER_TAG, self.SV.DOT_SIZE, self.DOT_SIZE)
    ...
    def setDotInvisible(self, invisible):
        ...
        self.CLIENT.sendData(self.CV.PLAYER_TAG, self.SV.DOT_INVISIBLE, invisible)
    ...
    def setDotSheild(self, isSheild):
        ...
        self.CLIENT.sendData(self.CV.PLAYER_TAG, self.SV.DOT_SHEILD, isSheild)

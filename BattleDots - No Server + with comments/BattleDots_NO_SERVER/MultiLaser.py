...
class MultiLaser():
    ...
    def createMultiLaser(self, dot_location_x, dot_location_y):
        ...
        '''
            Initiate a multi-laser by assigning variables.
    ...
    def updateAndDrawMultiLaser(self, screen, list_num, dot_movement_x, dot_movement_y, manageObjectsObject):
        ...
        '''
            Updates and draws a multi-laser location
    ...
    def checkMultiLaserLocation(self, list_num, ManageObjects_Object):
        ...
        '''
        Checks the Multi-lasers location to determine whether it is at a boundary or not.
        
        @params list_num: the location of the Multi-Laser to be destroyed in the Multi-Laser list

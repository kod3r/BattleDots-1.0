...
class Boundaries():
    ...
    def updateObstaclesAndPowerUpsMovement_X(self, addX):
        self.OBSTACLE_AND_POWERUPS_MOVEMENT_X = self.OBSTACLE_AND_POWERUPS_MOVEMENT_X - addX
        
    def updateObstaclesAndPowerUpsMovement_Y(self, addY):
        self.OBSTACLE_AND_POWERUPS_MOVEMENT_Y = self.OBSTACLE_AND_POWERUPS_MOVEMENT_Y - addY
